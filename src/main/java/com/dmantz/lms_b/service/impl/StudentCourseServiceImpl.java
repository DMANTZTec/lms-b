...
public class StudentCourseServiceImpl implements StudentCourseService {
    ...
    public StudentCourseServiceImpl(StudentCourseRepository studentCourseRepository, StudentCourseMapper studentCourseMapper, StudentRepository studentRepository, CourseRepository courseRepository) {
    ...
    public StudentCourseResponse enroll(StudentCourseEnrollRequest request) {
        ...
        studentCourseRepository.findByStudent_IdAndCourse_Id(student.getId(), course.getId())
                .ifPresent(sc -> {
    ...
    public List<StudentCourseResponse> getStudentCourses(String studentId) {
        ...
        List<StudentCourse> studentCourses =
                studentCourseRepository.findByStudent_StudentId(studentId);
